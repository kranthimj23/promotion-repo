        ...
        async function fetchProject() {
            try {
                ...
                if (res.ok) {
                    ...
                    if (data.environments && data.environments.length >= 2) {
                        setFormData(prev => ({
                            ...prev,
                            lowerEnv: data.environments[0].name,
                            higherEnv: data.environments[1].name
                        }));
                    }
                }
            } catch (err) {
    ...
    return (
        <div style={{ maxWidth: '800px' }}>
            <div style={{ marginBottom: '2rem' }}>
                <h1 style={{ fontSize: '1.875rem', fontWeight: 700, marginBottom: '0.5rem' }}>Create Release Note</h1>
