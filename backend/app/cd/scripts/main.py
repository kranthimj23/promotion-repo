...
def main():
    ...
    values_promotion_script = os.path.join(script_dir, "values-promotion.py")
    create_release_note_script = os.path.join(script_dir, "create-release-note.py")
    ...
    print(f"  ✓ Promoted values using values-promotion.py")
    print(f"  ✓ Generated release notes using create-release-note.py")
    print("\n")
