...
########################################################################################################################
#### Clone repository using git_helpers ####
########################################################################################################################

# Now use git_helpers.clone_single_branch_and_checkout() for cloning operations
...
def create_github_branch(github_url, base_branch, new_branch):
    ...
    try:
        ...
        # Use git_helpers for committing and pushing
